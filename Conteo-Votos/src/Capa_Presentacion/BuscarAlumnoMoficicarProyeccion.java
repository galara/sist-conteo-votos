...
import static Capa_Presentacion.ModificarProyeccionPagos.cGrupo;
import static Capa_Presentacion.ModificarProyeccionPagos.codigoa;
import static Capa_Presentacion.ModificarProyeccionPagos.estado;
import static Capa_Presentacion.ModificarProyeccionPagos.nombrealumno;
import static Capa_Presentacion.ModificarProyeccionPagos.idalumno;
 ...
 * @author GLARA
 */
public class BuscarAlumnoMoficicarProyeccion extends javax.swing.JInternalFrame {
     ...
     */
    public BuscarAlumnoMoficicarProyeccion() {
        initComponents();
        setFiltroTexto();
        addEscapeKey();
        limpiar();
...
//    }
    ...
    private void alumnosKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_alumnosKeyPressed
        ...
        if (key == java.awt.event.KeyEvent.VK_ENTER) {
            ...
            ModificarProyeccionPagos.llenarcombogrupo(alumnos.getValueAt(p, 0).toString());
